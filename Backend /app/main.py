...
llm = lambda prompt: "Based on the provided context, Backend API design focuses on scalable service interfaces."

reasoner = LLMReasoner(llm)
answer = reasoner.generate_answer(context, user_query)
